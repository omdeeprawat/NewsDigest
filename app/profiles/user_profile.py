USER_PROFILE = {
  "name": "omdeep",
  "title": "AI Enthusiast and Engineer",
  "background": "Recently graduated engineer with deep interest in practical AI applications, research breakthroughs, and production-ready systems",
  "interests": [
